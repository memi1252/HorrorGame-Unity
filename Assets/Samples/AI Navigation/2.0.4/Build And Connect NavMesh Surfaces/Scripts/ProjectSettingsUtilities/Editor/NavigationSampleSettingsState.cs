...
{
    /// <summary>
    ///     This ScriptableObject is used by the NavigationSampleProjectSettingsGenerator to check whether the generation of
    ///     agent types for the samples has already been done.
    ...
    {
        [SerializeField] private bool hasGeneratedSettings;
